    ...
    >
        <div class="basic-information__left">
            <div class="basic-information__left__item">
                <div class="basic-information__left__item__label">收运点照片</div>
            ...
            <div class="basic-information__left__item">
                ...
                <div class="basic-information__left__item__content">
                    {{
                        formData.townId ? communityList.find(element => element.value == formData.townId).label : ''
                    }}
                </div>
            </div>
            <div class="basic-information__left__item">
            ...
            <div class="basic-information__left__item">
                <div class="basic-information__left__item__label">收运点位置</div>
                <div class="basic-information__left__item__content">
                    {{formData.place ? formData.place : ''}}
                </div>
            </div>
            <div class="basic-information__left__item">
                <div class="basic-information__left__item__label">关联分类点</div>
                <div class="basic-information__left__item__content">
                    <span
                        class="basic-information__left__item__tag"
                        v-for="(site, index) in formData.garbageSortPointList"
            ...
            <div class="basic-information__left__item">
                <div class="basic-information__left__item__label">站点管理方</div>
                <div class="basic-information__left__item__content">
                    <span v-if="formData.delegating == '1'">物业</span>
                    <span v-if="formData.delegating == '2'">环卫</span>
                </div>
            </div>
            <div class="basic-information__left__item">
            ...
            <div class="basic-information__left__item">
                ...
                <div class="basic-information__left__item__content">
                    <span
                        class="basic-information__left__item__tag"
                        v-for="(participant, index) in formData.garbageMemberList"
            ...
            <div class="basic-information__left__item">
                <div class="basic-information__left__item__label">收运点位置描述</div>
                <div class="basic-information__left__item__content">
