<template>
  ...
  >
    ...
    <table class="static-table">
      ...
      >
        <td>{{ item.registerTime ? item.registerTime : "" }}</td>
      ...
      <tr v-if="tableList.length == 0">
        <td colspan="8" style="color: #999999; font-weight: normal">
          暂无数据
        </td>
      </tr>
    </table>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      const request = {
        method: "post",
        url: "garbage/garbageCollectionPoint/record",
    ...
    xlsRecordOutput() {
      ...
      const request = {
        method: "post",
        url: "/garbage/garbageCollectionPoint/xlsRecordOutput",
        baseURL: window.SITE_CONFIG.baseUrl,
        headers: {
