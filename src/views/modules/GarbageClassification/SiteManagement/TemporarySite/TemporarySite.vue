...
<template>
    <div>
        <sv-template
            ...
            :searchSetting="{
                width: '280px',
                placeholder: '请输入收运点名称、小区名称关键字'
            }"
            :tableRequest="tableRequest"
            :exportQrcodeConfig="{api: '/garbage/garbageCollectionPoint/getAllUrCode'}"
        ...
        <QrcodeDialog
            ref="QrcodeDialog"
            :api="['/garbage/garbageCollectionPoint/info', '/garbage/garbageCollectionPoint/output-UrCode']"
        />
        <!-- 删除提示弹窗 -->
