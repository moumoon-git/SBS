<template>
  <div class="inspectionSheetManagement">
    <div class="option-bar">
      ...
      <!-- 5. 导出按钮 -->
      <el-button plain type="primary" size="small" @click="exportEventData()"
        >导出</el-button
      >
      <!-- 6. 发布按钮 -->
      <el-button
    ...
    <el-row class="table-content">
      ...
      >
        <!-- 1. 工单名称 -->
        <el-table-column prop="name" label="工单名称" width="260">
        </el-table-column>
        <!-- 2. 工单类型 -->
        ...
        <!-- 3. 工单属性 -->
        <el-table-column prop="" label="工单属性">
          <template slot-scope="scope">
            <span>{{ workPropertyIdToName(scope.row.workProperty) }}</span>
          </template>
        </el-table-column>
        <!-- 4. 工单地点 -->
        <el-table-column prop="workPlace" label="工单地点"> </el-table-column>
        <!-- 5. 发布时间 -->
        <el-table-column prop="gmtCreate" label="发布时间"> </el-table-column>
        <!-- 6. 工单负责人 -->
        <el-table-column prop="" label="工单负责人">
          <template slot-scope="scope">
        ...
        <!-- 7. 工单时限 -->
        <el-table-column label="工单时限" width="200%">
          <template slot-scope="scope">
        ...
        <!-- 8. 工单状态 -->
        <el-table-column prop="" label="工单状态">
          <template slot-scope="scope">
            <span v-if="scope.row.status == 1" style="color: #0bd295"
              >已处置</span
            >
            <span v-if="scope.row.status == 0" style="color: #f7b500"
              >处置中</span
            >
            <span v-if="scope.row.status == -1" style="color: #999999"
              >已取消</span
            >
          </template>
        </el-table-column>
