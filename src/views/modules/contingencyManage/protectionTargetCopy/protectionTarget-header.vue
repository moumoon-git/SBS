          ...
          >
            <el-tooltip placement="top"  effect="light">
              ...
              <el-button
                ...
                element-loading-text="正在导入防护目标，可能需要几分钟时间，请耐心等待.."
...
export default {
  ...
  methods: {
    ...
    exportExcelAll () {
      ...
      // window.location.href = `${httpaddress}/resoure/resoureProtectTarget/xlsOutput?checkedIds=&token=${Cookies.get('token')}&search=`
      const request = {
        method: 'get',
        baseURL: window.SITE_CONFIG.baseUrl,
        url: '/resoure/resoureProtectTarget/xlsOutput',
        headers: {
