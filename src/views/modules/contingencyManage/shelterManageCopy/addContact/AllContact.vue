  ...
  <div class="allContact">
    ...
    <div class="wrap">
      <div class="outLine" style="position: relative;">
        <input class="search" placeholder="姓名、单位、职位、号码检索" v-model="key" />
        <i class="el-icon-search" style="position: absolute;right: 8%;top: 50%;transform: translateY(-50%);" @click="searchContact"></i>
      </div>
      <!-- 不使用树形的复选框-->
      <div class="checkWrap">
