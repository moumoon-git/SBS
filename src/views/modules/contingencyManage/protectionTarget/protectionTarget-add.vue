<template>
  <el-dialog
    ...
    @closed="$parent.addVisible=false"
  >
    <el-form
      :model="dataForm"
      :rules="dataRule"
    ...
    >
      ...
      <el-form-item label="地址">
        <el-input v-model="dataForm.location" style="width: 90%" :readonly="true"></el-input>
        <el-button
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="主体单位">
            <el-input v-model="dataForm.chargeUnit" ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-form-item label="防护措施">
        <el-input :rows="2" v-model="dataForm.conservatoryMeasure" ></el-input>
      </el-form-item>

      <el-form-item label="应急通讯方式">
        <el-input type="textarea" :rows="1" v-model="dataForm.communicationMode" resize="none" ></el-input>
      </el-form-item>

      <el-form-item label="备注">
        <el-input type="textarea" :rows="2" v-model="dataForm.remark" resize="none" ></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        .then(({ data }) => {
          if (data.code == 0) {
            ...
            this.areaList = treeDataTranslate(data.data, "id");
          } else {
            this.$message.error(data.msg);
          }
        })
    ...
    addContactHandle(type) {
      if (type == "联系人") {
        this.$refs.AddContactView.getTableList(type, this.dataForm.contactsId);
      } else if (type == "负责人") {
        this.$refs.AddContactView.getTableList(type, this.dataForm.chargeId);
      }
    },
    delIt(type, id) {
      if (type == "contact") {
