    ...
    <el-container>
      <el-header>
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
                 label-width="190px">
          <el-form-item label="请选择上级防护目标" v-if="type===2" prop="eventTypeParentName">
            <el-dialog
              title="请选择要新增到的分组节点"
          ...
          <el-form-item label="防护目标名称" prop="name">
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid && (this.type === 2 || this.type === 3)) {
            this.$http({
              url: this.$http.adornUrl(`/resoure/resoureProtectGroup/${this.type === 2 ? 'save' : 'update'}`),
              method: 'post',
