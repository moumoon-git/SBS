<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="物资图片:" >
        ...
        <template v-if="status===1">
          <img v-if="dataForm.picPath" :src="baseUrl + dataForm.picPath" class="avatar" />
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </template>
        <template v-else>
          <img :src="baseUrl + dataForm.picPath" class="avatar" />
        </template>
        </el-upload>
      </el-form-item>
    ...
    <span slot="footer" class="dialog-footer" v-if="status===1">
        ...
        if (this.dataForm.id) {
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.dataForm.articleStorehouseName =
                data.resoureArticle.storehouseName;
