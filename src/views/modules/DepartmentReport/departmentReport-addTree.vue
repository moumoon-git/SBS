<template>
  <el-dialog title="新增物资仓库" :close-on-click-modal="false" :visible.sync="visible">
    <el-container>
      <el-header>
        <el-form
          :model="dataForm"
        ...
        >
          <el-form-item label="物资库名称" prop="name">
            <el-input v-model="dataForm.name" v-bind:readonly="type===1"></el-input>
          </el-form-item>

          <el-form-item label="仓库所在地" prop="contactor_ids">
            <el-input
              type="textarea"
              :rows="1"
              resize="none"
          ...
          <el-form-item label="物资库面积" prop="acreage">
            <el-input v-model="dataForm.name" v-bind:readonly="type===1"></el-input>
          </el-form-item>

          <el-form-item label="主管单位" prop="responsibleUnitId" v-if="type===2">
          ...
          <el-form-item label="主管单位地址" prop="responsibleUnitAddress">
            <el-input v-model="dataForm.responsibleUnitAddress" v-bind:readonly="type===1"></el-input>
          </el-form-item>

          <el-form-item label="请选择负责人" prop="contactor_ids" v-if="type===2">
          ...
          <el-form-item label="周边交通" prop="aroundTraffic">
            <el-input v-model="dataForm.aroundTraffic" v-bind:readonly="type===1"></el-input>
          </el-form-item>

          <el-form-item label="物资库描述" prop="remark">
            <el-input v-model="dataForm.name" v-bind:readonly="type===1"></el-input>
          </el-form-item>
        </el-form>
      </el-header>
  ...
  data() {
    ...
    return {
      ...
      dataRule: {
        ...
        responsibleUnitId: [{ required: true, message: "主管单位不能为空" }],
        contactor_ids: [
