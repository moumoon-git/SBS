  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-form-item>
        ...
        >
        <el-button
          v-if="isAuth('resoure:resourearticletype:save')"
        ...
        >
        <el-button
          v-if="isAuth('resoure:resourearticletype:delete')"
          @click="deleteHandle()"
      ...
      <el-table-column header-align="center" align="center" label="操作">
        <template slot-scope="scope">
          <el-button
            ...
            >修改</el-button
          >
          <!-- <el-button type="primary" @click="deleteHandle(scope.row.id)" size="small">删除</el-button> -->
          <el-button
            type="primary"
