      ...
      <el-header style="height:120px">
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
          ...
          <el-form-item label="分组描述">
           ...
           <el-form-item label="域模式" prop="scheme">
            <el-select v-model="dataForm.scheme" placeholder="请选择">
              <el-option
        ...
        if (valid && (this.type === 2 || this.type === 3)) {
          this.$http({
            url: this.$http.adornUrl(
              `/vcm/vcmHumanGroup/${this.type === 2 ? 'save' : 'update'}`
            ),
            method: 'post',
            data: this.$http.adornData({
              ...
              scheme:this.dataForm.scheme,
              type:this.dataForm.type,
              description: this.dataForm.gmtCreate,
              // orderNum: '1',
