<template>
  <div style="min-width:320px;">
    <el-header style="height: 48px;padding: 5px;border: 1px solid rgb(229, 229, 229);text-align: center;" class="operation-btn">
      <el-tooltip effect="dark" content="查看" placement="top" v-if="isAuth('event:eventType:info')">
        <el-button type="success" size="small" @click="showTree()">查看</el-button>
      </el-tooltip>
      <el-tooltip effect="dark" content="添加" placement="top" v-if="isAuth('event:eventType:save')">
        <el-button type="primary" size="small" @click="addTree()">添加</el-button>
      </el-tooltip>
      <el-tooltip effect="dark" content="修改" placement="top" v-if="isAuth('event:eventType:update')">
        <el-button type="warning" size="small" @click="updateTree()">修改</el-button>
      </el-tooltip>
      <el-tooltip effect="dark" content="删除" placement="top" v-if="isAuth('event:eventType:delete')">
