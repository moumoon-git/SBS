<template>
  <div>
    <el-row :gutter="20">
      <el-row :gutter="10">
        <el-button type="primary" @click="addDistributionControl">新增</el-button>
        <el-button type="primary" @click="startDistributionControlGroup('true','')">批量启动</el-button>
        <el-button type="primary" @click="startDistributionControlGroup('false','')">批量禁用</el-button>
        <el-button type="primary" @click="delDistributionControlGroup('')">批量删除</el-button>
        <el-table
          :data="tableData"
