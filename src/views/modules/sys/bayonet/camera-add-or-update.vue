<template>
  <el-dialog title="新增相机到卡口" :close-on-click-modal="false" :visible.sync="visible" width="1000px">
    <el-row :gutter="20">
      <el-col :span="8">
        <tree :list="modifiedUserList" :listProps="modifiedUserProps" :handleTree="clickType" @bayonetType="getDatatree" @handleNodeClickCamera="handelNodeClick"></tree>
      </el-col>
      <el-col :span="8">
