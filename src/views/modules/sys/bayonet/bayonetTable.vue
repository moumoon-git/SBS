  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('risk:riskvehiclealarm:save')" type="primary" @click="addEventType()">新增</el-button>
...
import bayonetVue from './bayonet.vue'
