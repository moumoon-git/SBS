    ...
    <el-container>
      <el-header>
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
                 label-width="190px">
          <el-form-item label="请选择上级队伍类型" prop="eventTypeParentName" v-if="type===2">
            <el-dialog
              title="请选择要新增到的分组节点"
          ...
          <el-form-item label="队伍类型名称" prop="name">
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid && (this.type === 2 || this.type === 3)) {
            this.$http({
              url: this.$http.adornUrl(`/resoure/resoureteamtype/${this.type === 2 ? 'save' : 'update'}`),
              method: 'post',
