<template>
  <el-dialog :title="dataForm.id ? '查看负责人' : '联系人新增'" :close-on-click-modal="false" :visible.sync="visible" :width="dataForm.id?'1000px':'800px'">
      ...
      <el-main>
        <el-form :model="dataForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              ...
              <el-form-item label="紧急联系人">
                <!-- <el-radio v-model="dataForm.importance" :label=1>是</el-radio>
                <el-radio v-model="dataForm.importance" :label=0>否</el-radio>-->
            ...
            <el-col :span="12">
              ...
              <el-form-item label="其他号码" size="large" prop="mobile2">
          ...
          <el-form-item label="人物所在地">
            ...
            <!-- <el-button @click="dialogVisible = true" style="width:8%" type="text" icon="el-icon-location-outline">定位</el-button> -->
          </el-form-item>
        </el-form>
      </el-main>
    </el-container>
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="handleInform()">选择其他责任人</el-button>
    </span>
    <!--地图弹窗-->
