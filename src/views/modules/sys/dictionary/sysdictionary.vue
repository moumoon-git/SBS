<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()" style="position:relative;">
      ...
      <el-button type="primary" class="save" @click="searchResult()">查询</el-button>
      <el-form-item style="position:absolute;right:-0.6%;">
        
        <el-button class="save" v-if="isAuth('sys:sysdictionary:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button class="save" v-if="isAuth('sys:sysdictionary:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
