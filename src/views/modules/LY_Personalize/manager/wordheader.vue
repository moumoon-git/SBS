  ...
  <div style="min-width: 1344px;">
    <el-form>
      <el-form-item style="">
        ...
        <el-date-picker unlink-panels v-model="value3" value-format="yyyy-MM-dd HH:mm:ss" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" size="small"></el-date-picker>
        ...
        <el-input style="width:300px;" v-model="value4" placeholder="请输入所属区域/工单编号/类型名称/内容" clearable size="small"></el-input>
        <el-button  @click="searchHandle()" type="primary" size="small">搜索</el-button>

        <el-button  @click="exportEventData()" type="primary" size="small">导出</el-button>
