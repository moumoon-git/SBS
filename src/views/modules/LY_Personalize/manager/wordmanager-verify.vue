      ...
      <el-form ref="eventDetailForm" :model="eventDetailForm" label-width="80px">
        ...
        <el-form-item label="派遣人员">
          <!-- <el-popover
            ...
            <el-input v-model="eventDetailForm.contactorName"
    ...
    methods: {
          ...
          if (valid) {
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                //联系人id
                contactorId: this.eventDetailForm.contactorId
      ...
      handelLinkdata({linkman}){
        ...
        linkman.forEach(item=>{
          this.eventDetailForm.contactorId = item.id;
          this.eventDetailForm.contactorName = item.name;
          this.eventDetailForm.contactorMobile = item.mobile1;
          this.eventDetailForm.contactorOpenId = item.openId;
        })
      }
