<template>
  <div style="min-width: 1344px;">
    <el-form style="z-index: 999999 !important;">
      <el-form-item style="">

        <el-button style="background: #38ADFF;color: #fff;width: 200px;" @click="clickAllHandle()">全部</el-button>

        <!--<el-button style="background: #38ADFF;color: #fff;width: 200px;margin-bottom: 10px">查看热力图</el-button>-->
