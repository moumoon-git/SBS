<template>
  <div style="min-width: 1248px;height:56px;padding:10px">
    <el-form :inline="true" @keyup.enter.native="searchHandle()">
      <el-form-item style="display: flex;margin:0">
        ...
        <el-date-picker
          ...
          style="min-width:300px;width:20vw;"
          class="searchMargin"
          size="small"
        ></el-date-picker>
        ...
        <el-input
          ...
          size="small"
        ></el-input>
        <el-select v-model="status" clearable placeholder="请选择状态" class="searchMargin" size="small">
