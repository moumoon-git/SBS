            ...
            <el-row>
              <el-col :span="12">
                <div style="display: flex;justify-content: center;width: 100%;">
                  ...
                  <!-- ***修改后的代码*** -->
                  <div
                    class="school__card-item"
                    v-for="(card, cardIndex) in cardData"
                    :key="`schoolCardItem_${cardIndex}`"
                  >
                    <div class="school__card-item__count">{{ card.allCount }}</div>
                    <div class="school__card-item__name">{{ card.name }}</div>
                  </div>
                  <!-- ***结束*** -->
                </div>
              </el-col>
