<template>
  <el-dialog
    ...
    @close="serviceObject=[];serviceObjectData=[];dialogVisible=false;$parent.showServiceObjectDialog=false;"
    width="35%"
  >
    <el-transfer
      filterable
  ...
  mounted() {
    setTimeout(() => {
      if (document.querySelectorAll(".el-transfer-panel")[0]) {
        ...
        document
          .querySelectorAll(".el-transfer-panel")[0]
