        ...
        />
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <span v-if="true">
                            <img class="operation-icon" src="../../../../assets/img/show.svg" alt="查看" @click="showViewSheet(scope.row.id)" 
                            ...
                            <img class="operation-icon" src="../../../../assets/img/edit.svg" alt="编辑" @click="showReleaseSheet(scope.row.id)" 
                            style="cursor:pointer;width:20px;margin-right: 10px"/>
                            <img class="operation-icon" src="../../../../assets/img/del.svg" alt="删除" @click="deletRow(scope.row.id)"
                            style="cursor:pointer;width:20px;margin-right: 10px"/>
              <span
