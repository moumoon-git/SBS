                ...
                <template>
                  <el-row>
                    ...
                    >
                      ...
                      <el-col
                        v-if="(eventDetailForm.flagType === 3 || eventDetailForm.flagType === 4) &&
                          eventDetailForm.smallPicUrl.length"
                        :span="12"
                        class="demo-image__preview"
                      >
                        <viewer :images="eventDetailForm.smallPicUrl">
                          <img
                            :src="eventDetailForm.smallPicUrl[0].indexOf('http')>-1?
                              eventDetailForm.smallPicUrl[0]:
                              backgroundURL+eventDetailForm.smallPicUrl[0]"
                            width="120"
                            height="120"
                          >
                        </viewer>
...
export default {
  ...
  methods: {
    ...
    init (row) {
      ...
      this.eventDetailForm.smallPicUrl = row.smallPicUrl ? [row.smallPicUrl] : [];
      this.eventDetailForm.flagType = row.flagType;
