    ...
    <el-row>
      <el-col :span="24">
        ...
        >
          ...
          <el-tab-pane label="校园预警" name="6">
           <!-- 处理中-->
          </el-tab-pane> 
          <el-tab-pane label="违规预警" name="8">
            <!--处理中-->
          </el-tab-pane>
          <el-tab-pane label="视频监控" name="9">
            <!--处理中-->
          </el-tab-pane>
          <el-tab-pane label="巡查发现" name="10">
            <!--处理中-->
          </el-tab-pane>
          <el-tab-pane label="要情记录" name="12">
            <!--处理中-->
          </el-tab-pane>
        </el-tabs>
...
<script>
import WordManagerHeader from "@/views/modules/word/manager/wordheader";
