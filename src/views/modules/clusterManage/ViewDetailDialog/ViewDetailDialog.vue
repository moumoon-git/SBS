      ...
      >
        <div class="basic-information__left">
          <div class="basic-information__left__item">
            <div class="basic-information__left__item__label">集群名称</div>
            <div class="basic-information__left__item__content">
              {{ formData.name ? formData.name : "" }}
            </div>
          </div>
          <div class="basic-information__left__item">
            <div class="basic-information__left__item__label">集群类型</div>
            <div class="basic-information__left__item__content">
              <span v-if="formData.type == '1'">集群终端</span>
              <span v-if="formData.type == '2'">分组</span>
            </div>
          </div>
          <div class="basic-information__left__item">
            <div class="basic-information__left__item__label">集群号码</div>
            <div class="basic-information__left__item__content">
              {{ formData.num ? formData.num : "" }}
            </div>
          </div>
          <div class="basic-information__left__item">
