    ...
    <div style="padding: 10px;margin-right:10px;width: 100%;display: flex;justify-content: center;">
      ...
      <div style="width: 20%;margin-left: 10px">
        <el-card :body-style="{padding: '0px'}">
          ...
          <div style="display: flex;justify-content: center;margin-top: 20px">
            <span style="font-size: 18px;font-weight: bold;color: #81d481;" v-text="public">798</span>
          </div>

          <div class="bottom" style="display: flex;justify-content: center;margin-top:10px; margin-bottom: 0px">
            <el-button type="text"
                       class="button"
                       @click="clickPopup('public')"
                       style="width: 100%;background-color: #81d481;font-size: 16px;font-weight: bold;color: white;">公共安全</el-button>
          </div>
      ...
      <div style="width: 20%;margin-left: 10px">
        <el-card :body-style="{padding: '0px'}">
          ...
          <div style="display: flex;justify-content: center;margin-top: 20px">
            <span style="font-size: 18px;font-weight: bold;color: #4eb6d4;" v-text="traffic">0</span>
          </div>

          <div class="bottom" style="display: flex;justify-content: center;margin-top:10px; margin-bottom: 0px">
            <el-button type="text"
                       class="button"
                       @click="clickPopup('traffic')"
                       style="width: 100%;background-color: #4eb6d4;font-size: 16px;font-weight: bold;color: white;">交通安全</el-button>
          </div>
      ...
      <div style="width: 20%;margin-left: 10px">
        <el-card :body-style="{padding: '0px'}">
          ...
          <div style="display: flex;justify-content: center;margin-top: 20px">
            <span style="font-size: 18px;font-weight: bold;color: #a74534;" v-text="food">0</span>
          </div>

          <div class="bottom" style="display: flex;justify-content: center;margin-top:10px; margin-bottom: 0px">
            <el-button type="text"
                       class="button"
                       @click="clickPopup('food')"
                       style="width: 100%;background-color: #a74534;font-size: 16px;font-weight: bold;color: white;">食品安全</el-button>
          </div>
        ...
        <el-card :body-style="{padding: '0px'}">
          ...
          <div class="bottom" style="display: flex;justify-content: center;margin-top:10px; margin-bottom: 0px">
            <el-button type="text"
                       ...
                       style="width: 100%;background-color: #dcaf12;font-size: 16px;font-weight: bold;color: white;">管理安全</el-button>
          </div>
        ...
        <el-card :body-style="{padding: '0px'}">
          ...
          <div class="bottom" style="display: flex;justify-content: center;margin-top:10px; margin-bottom: 0px">
            <el-button type="text"
                       ...
                       style="width: 100%;background-color: #4a87e2;font-size: 16px;font-weight: bold;color: white;">其他安全</el-button>
          </div>
