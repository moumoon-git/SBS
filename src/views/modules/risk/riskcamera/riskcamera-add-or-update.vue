  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="110px">
      <el-form-item label="相机名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入相机名称"></el-input>
      </el-form-item>
      <el-form-item label="地址" prop="address" style="position:relative;">
      <el-input v-model="dataForm.address" placeholder="请定位地址" readonly style="width: 90%"></el-input>
      ...
      <el-form-item v-if="cameraValue=='0'" label="设备编号" prop="indexCode">
        <el-input v-model="dataForm.indexCode" placeholder="请输入设备编号"></el-input>
      </el-form-item>
      <el-form-item v-if="cameraValue=='1'" label="卡口编码" prop="crossingId">
        <el-input v-model="dataForm.crossingId" placeholder="请输入卡口编码"></el-input>
      </el-form-item>
      <el-form-item v-if="cameraValue=='2'" label="视频预览编码" prop="videoCode">
        <el-input v-model="dataForm.videoCode" placeholder="请输入视频预览编码"></el-input>
      </el-form-item>
      <el-form-item label="业务编码" prop="businessCode">
        <el-input v-model="dataForm.businessCode" placeholder="请输入业务编码"></el-input>
      </el-form-item>
      <el-form-item label="硬件编码" prop="hardwareCode">
        <el-input v-model="dataForm.hardwareCode" placeholder="请输入硬件编码"></el-input>
      </el-form-item>
...
export default {
  data () {
    ...
    return {
      ...
      options: [{ value: 1, label: '可用' }, { value: 0, label: '不可用' }],
      visible: false,
      dataForm: {
        id: 0,
        name: '',
