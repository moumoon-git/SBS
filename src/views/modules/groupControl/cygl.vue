    ...
    <div class="cygl">
      <div class="header">
        ...
        >
          ...
          <div class="addDialog_left">
            ...
            <sv-upload v-model="addApplication.documents" />
          </div>
          <!-- 附件模块 -->
      ...
      <div class="content">
        <el-table
          ...
          border
          :height="shgl > 0 ? 'calc(100vh - 350px)' : 'calc(100vh - 240px)'"
        >
          <el-table-column
            align="center"
            v-if="moreBtnIsFocus"
          ...
          <el-table-column align="right" width="150" label="操作">
            <template slot-scope="scope">
              ...
              <div v-else>
                <el-tooltip
                  v-show="scope.row.statusString == '待提交'"
                  class="item"
                  effect="dark"
                  content="审核"
                  placement="top"
                ...
                <!-- 重新报审 -->
                <el-tooltip
                  v-show="scope.row.statusString == '已驳回'"
                  class="item"
                  effect="dark"
                  content="审核"
                  placement="top"
                  ...
                  <img
                    ...
                    :class="
                      scope.row.statusString == '待审核'
                        ...
                        : 'redButton'
                    "
                    @click="delectInformation(scope.row)"
                ...
                <div style="width: 1090px; borderright: 1px solid #f0f0f0">
                  ...
                  <div v-show="toggleInformation">
                    ...
                    <el-form :model="form" style="display: flex">
                      <div class="image_watch" v-viewer>
                        <el-form-item
                        ...
                        >
                          <img
                            ...
                            style="width: 101px; height: 125px; cursor: zoom-in"
                          />
                        </el-form-item>
                        <!-- 默认头像 -->
                        <!-- <el-form-item
                        ...
                        >
                          <img
                            ...
                            style="width: 164px; height: 105px; cursor: zoom-in"
                          />
                        </el-form-item>
                        <el-form-item
                      ...
                      <div class="watch_information_left" style="width: 400px">
                        ...
                        <el-form-item
                          label="离职原因"
                          :label-width="formLabelWidth"
                          >{{ detailData.remark }}</el-form-item
                        >
                      </div>
                    ...
                    <div
                      ...
                      v-for="(
                        item, index
                      ) in detailData.curriculumVitaeEntities"
                    ...
                    <sv-upload v-model="detailData.documents" :isView="true" />
                    <!-- 评论审核框 -->
            ...
            >
              ...
              <div class="editDialog_left">
                ...
                <sv-upload v-model="detailData.documents" />
  ...
  methods: {
    ...
    viewComment(id) {
      this.$http({
        ...
        if (
          data.data.data.approveManageEntity &&
          data.data.data.approveManageEntity.comment
        ) {
          this.$alert(data.data.data.approveManageEntity.comment, "驳回原因", {
            confirmButtonText: "确定",
          });
        } else {
          this.$alert("暂无驳回原因", "驳回原因", {
            confirmButtonText: "确定",
          });
        }
      });
      ...
      this.$confirm("确定要进行[删除]操作?", "提示", {
        ...
        .then(() => {
          if (row.status == 1 || row.status == 2) {
            ...
            let id = row.id;
            this.$http({
              url: this.$http.adornUrl(`/approve/approveMemberEntity/delete`),
              method: "post",
    ...
    confirmEditEntryApply() {
      ...
      //   submitManageId = -300;
      // }
      console.log("成员管理id", submitManageId, this.manageId);
      this.$http({
        url: this.$http.adornUrl(`/approve/approveMemberEntity/update`),
        method: "post",
        data: this.$http.adornData({
          id: this.idNum,
    ...
    getDetail(index, dialog) {
      ...
      this.$http({
        ...
        this.accountType = data.data.data.accountType;
    ...
    getDataDetail(index) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          console.log("流程列表数据", this.processList);
          //获取审批流程
          this.unitList = [];
          for (
            let depIndex = 1;
          ...
          if (
            ...
            let choosePlatformid = this.processList[index].approveApproveEntity
              .platformId;
            console.log("测试流程列表索引数据", this.processList[index]);
    ...
    downloadtemplate() {
      ...
      const url = `${httpaddress}/approve/approveMemberEntity/gettemplate?token=${Cookies.get(
        "token"
      )}`;
      const request = {
        method: 'get',
...
.operation__view {
  ...
  left: -10px;
  margin-left: 10px;
  background: no-repeat url("../../../assets/img/eye.svg") center/100% 100%;
  &:hover {
    cursor: pointer;
    background: no-repeat url("../../../assets/img/eye2.svg") center/100% 100%;
  }
}
</style>