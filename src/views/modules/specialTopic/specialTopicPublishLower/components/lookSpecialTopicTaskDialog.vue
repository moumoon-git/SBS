 ...
 * @LastEditTime: 2020-12-16 13:39:04
      ...
      <div class="dialogWrapper">
        <div class="topContent">
          ...
          <div class="confirmWrapper">
            ...
            <div class="confirmText" v-if="Number(dataForm.valueSwitch)">已开启</div>
            <div class="confirmText" v-if="!Number(dataForm.valueSwitch)">未开启</div>
...
export default {
  ...
  methods: {
    ...
    init(data) {
      ...
      console.log("222222222222222", totalContactorList);
