 ...
 * @LastEditTime: 2021-01-06 17:02:52
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \SBS\src\views\modules\specialTopic\specialTopicPublishTop\specialTopicPublishTop.vue
-->
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/fk/fkTask/list'),
        method: 'post',
