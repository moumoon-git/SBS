 ...
 * @LastEditTime: 2021-01-19 16:03:35
  ...
  <div class="publishSpecialTopicTaskDialog">
    ...
    >
      <el-form
        ...
        class="dialog_form"
      >
        <el-form-item ref="dataFrom" label="任务名称" prop="taskName">
          <el-input v-model="dataForm.taskName" />
        </el-form-item>
        <el-form-item ref="dataForm" label="任务说明" prop="remark">
          <el-input v-model="dataForm.remark" type="textarea" rows="2" />
        </el-form-item>
        <el-form-item ref="dataForm" label="专题模板" prop="templateId">
          <el-input readonly :value="templateData.name"></el-input>
        </el-form-item>
        ...
        <el-form-item
          ...
          prop="remindDay"
        >
          <el-input v-model="dataForm.remindDay" placeholder="请填写天数" />
        </el-form-item>
        <el-form-item
          v-if="dataForm.valueSwitch == 1"
          label="通知方式"
            ...
            <div class="platform_slide">
              ...
              >
                ...
                <span
                  ...
                  @click="delectUnitType(item)"
                />
              </span>
            </div>
            <sv-button style="margin: 5px" @click="getItemModel()">
              新增平台+
            </sv-button>
          </div>
      ...
      <div class="dialog_footer">
        <sv-button width="52px" @click="cancelEdit()"> 取 消 </sv-button>
        <sv-button
          type="primary"
          width="52px"
    ...
    init(data) {
      ...
      this.$http({
        ...
        if (data && data.code == 0) {
          ...
          this.dataForm.templateId = data.data.templateInstanceId;
          this.templateData = { name: data.data.templateName, id: data.data.templateId, phone: '' };

          console.log(
            'cscscscscs',
            this.dataForm.radio,
            this.dataForm.isChooseTemplate,
            this.templateData,
          );
          this.dataForm.isChooseTemplate = data.data.isChooseTemplate;
          this.dataForm.platformList = data.data.platformList;
          console.log('platformListcccx', data.data.platformList);
          this.dataForm.platformList.forEach((v) => {
            this.checkList.push(v.platformId);
          });
          // 初始时获取this.platList好判断全选按钮状态
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              if (this.dataForm.platformList.length === 0) {
                ...
                this.dataForm.platformList.length > 0
                && this.dataForm.platformList.length !== this.platList.length
              ) {
      ...
      console.log('this.dataForm.taskSwitch', this.dataForm.taskSwitch);
      ...
      const totalContactorList = data.contactorList;
      ...
      this.$refs.dataForm.validate((vaild) => {
        if (vaild) {
          ...
          this.dataForm.contactorList.forEach((item) => {
            contactorList.push({ contactorId: item.id, type: '1' });
          });
          this.$http({
