  ...
  <div class="reward-message">
    <div class="message-all-container">
      ...
      <div class="message-content-wrapper">
        ...
        >
          <!-- <div class="message-content-header-title">车辆信息</div> -->
          <el-tabs
            v-model="tikuType"
...
import ResourceAddUpdate from '../tjf/checkDialog';
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/approve/approveReward/listByPlatform'),
        method: 'post',
    ...
    exportSelectAll() {
      ...
      this.$http({
        url: this.$http.adornUrl(
          '/approve/approveReward/xlsOutputSelectInstance',
        ),
        method: 'post',
        data: this.$http.adornData({
    ...
    exportSearchAll() {
      this.$http({
        url: this.$http.adornUrl(
          '/approve/approveReward/xlsOutputConditionInstance',
        ),
        method: 'post',
        data: this.$http.adornData({
          page: this.pageIndex,
