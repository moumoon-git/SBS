...
export default {
  ...
  methods: {
    ...
    init(id, type, manageType) {
      ...
      console.log("id", id, type, this.tabType, "新的11111111111");
      this.clickId = id;
        ...
        this.$refs["dataForm"].validate((valid) => {
          ...
          if (valid) {
            if (this.tabType == "first") {
              ...
              this.$http({
                url: this.$http.adornUrl(
                  `/approve/approveCarAccount/${
                    !this.dataForm.id ? "save" : "updateAccountType"
                  }`
                ),
                method: "post",
        ...
        this.$refs["dataForm2"].validate((valid) => {
          if (valid) {
            if (this.tabType == "second") {
              ...
              this.$http({
                url: this.$http.adornUrl(
                  `/approve/approveBoxAccount/${
                    !this.dataForm2.id ? "save" : "updateAccountType"
                  }`
                ),
                method: "post",
                data: this.$http.adornData({
