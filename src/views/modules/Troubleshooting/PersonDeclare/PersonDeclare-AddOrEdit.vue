      ...
      <div class="info" style="display:flex;justify-content:space-between;">
        <div>
          <el-col :span="electronicId?6:6">
            <img
              id="image"
              v-if="electronicId && detailData.imgUrl"
          ...
          <el-col :span="18">
            <el-form ref="form" :model="detailData" :rules="rules" label-width="120px">
              ...
              <el-form-item label="性别" prop="sex">
                <el-select v-model="detailData.sex" placeholder="请选择性别" style="width:100%">
    ...
    <el-row :gutter="20">
      <div class="info">
        ...
        <template>
          ...
          >
            <p style="margin:5px;font-weight:bold;color:#333;">
            ...
            <template v-if="item.topicName==='单选题'">
              <el-radio-group v-model="item.answer">
                ...
                <span v-for="v in item.epiSelectEntityList" style="margin-right: 30px;" :key="v.id">
                  <el-radio :label="v.id">
                    {{v.content}}
                    <input
            ...
            <template v-if="item.topicName==='混答+多选'">
              <el-checkbox-group v-model="item.answer">
                ...
                <span v-for="v in item.epiSelectEntityList" style="margin-right: 20px;" :key="v.id">
            ...
            <template v-if="item.topicName==='混答+单选'">
              <el-radio-group v-model="item.answer">
                ...
                <span v-for="v in item.epiSelectEntityList" :key="v.id" style="margin-right: 30px;">
                  <el-radio :label="v.id">
                    {{v.content}}
      ...
      this.$http({
        ...
        .then(({ data }) => {
          ...
          if (data && data.code === 0) {
            ...
            this.registeinfor[idx].answer.push({
              name: data.data.name,
              url: this.baseUrl + urlStr,
              path: urlStr,
              oldPath: this.baseUrl + urlStr,
            });
      ...
      if (sure) {
        this.$refs["form"].validate((valid) => {
          if (valid) {
            ...
            this.$http({
              url: this.$http.adornUrl(
                `/perpass/perpassRegister/${
                  this.electronicId ? "update" : "save"
                }`
              ),
              method: "post",
              data: {
