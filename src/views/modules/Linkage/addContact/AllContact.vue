      ...
      <div class="checkWrap">
        <aside class="checkList">
          <el-checkbox
            ...
            style="border:none;padding-left:10px;background:rgba(251,252,255,1);width:100%;height:33px;line-height:0px;"
          >
...
// 复选框选中样式
/deep/ .checkList .el-checkbox__input.is-checked .el-checkbox__inner, .checkList .el-checkbox__input.is-indeterminate .el-checkbox__inner{
  background-color: #0091ff !important;
