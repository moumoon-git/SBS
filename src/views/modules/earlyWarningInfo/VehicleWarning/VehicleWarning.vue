<template>
  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-form-item>
        <el-input class="search" v-model="dataForm.key" placeholder="请输入车牌号搜索" clearable></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-select v-model="dataForm.typeId" placeholder="请选择管控类型">
          <el-option
      ...
      <el-form-item>
        <el-button @click="getDataList()" style="background: #409eff;color: #fff;margin-left: initial;">查询</el-button>
        <el-button @click="switchingMode()" v-if="!switchView" style="background: #409eff;color: #fff;margin-left: initial;">列表模式</el-button>
        <el-button @click="switchingMode()" v-else style="background: #409eff;color: #fff;margin-left: initial;">卡片模式</el-button>
            ...
            <div>
              ...
              <div class="right">
                <ul>
                  ...
                  <li>
                    <label>经过时刻:{{item.alarmTime}}</label>
                    <span></span>
                  </li>
                  <li>
