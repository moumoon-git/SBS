  ...
  <div>
    ...
    >
      <div class="clearfloat">
        ...
        <img
          id="image"
          :data-original="dataForm[0].picAbbreviate"
          :src="dataForm[0].picAbbreviateMin"
          style="width: 200px; height: 200px;margin-right:2vw"
        />

        <div class="textBox" style="width:200px">
          <p>时间:{{dataForm[0].alarmTime}}</p>
          <p>车牌号:{{dataForm[0].plateInfo }}</p>
          <p>车辆类型:{{dataForm[0].type}}</p>
          <p>摄像头名称:{{dataForm[0].cameraName}}</p>
        </div>
      </div>
      ...
      <el-row class="riskvehiclealarm-table">
        ...
        >
          <el-form-item>
            <el-input v-model="timeStrings.cameraName" placeholder="请输入摄像头名" clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-date-picker
          ...
          <el-form-item>
            <el-button @click="init(index)">查询</el-button>
        ...
        <el-col>
          <el-table :data="dataForm" style="width: 100%;overflow:auto">
            <el-table-column
              ...
              width="110"
            ></el-table-column>
            <el-table-column prop="plateInfo" header-align="center" align="center" label="车牌号"></el-table-column>
            <el-table-column prop="cameraName" header-align="center" align="center" label="摄像头"></el-table-column>
            <el-table-column prop="cameraAddress" header-align="center" align="center" label="卡口地址"></el-table-column>
            <el-table-column header-align="center" align="center" label="抓拍图片" width="225">
              <template slot-scope="scope">
                ...
                <viewer :images="[scope.row.picPlate?scope.row.picPlate:imageUrl]">
                  <img
                    v-for="(item,index) in [scope.row.picPlate?scope.row.picPlate:imageUrl]"
                    :src="item"
                    :key="index"
                    width="100"
                    height="100"
      ...
      <!--点击查看，弹出查看窗口-->
      <riskvehiclealarm-view v-if="riskvehiclealarmViewVisible" ref="riskvehiclealarmView"></riskvehiclealarm-view>
      <!--点击派单，弹出查看窗口-->
