...
import icp19 from "@/assets/js/HWICP-19.0/ucsApi.js";
...
export default new Vuex.Store({
  ...
  state: {
    ...
    caseId: null, // 事件类型id
    navTree: [],  // 导航菜单树
        defaultactive:'',    // 当前路由位置
        menuID:'',//当前路由ID
        linkage: false,  // 三级联动按钮显示隐藏
    isCallIng:false,
  },
  //这里是set方法
  mutations: {
    ...
    setSituation(state, situation) {
      state.eventSituation = situation;
    },
  ...
  linkageBtn(state, linkage){  // 设置导航菜单树
  ...
  getters: {
    ...
    getTurnToTextLoading: state => state.loading,
