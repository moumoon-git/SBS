...
var getLunarDay=require('../../../utils/getLunarDay');
...
var Calendar = {
  ...
  methods: {
    ...
    dateCellRender2: function dateCellRender2(value) {
      ...
      // console.log("value.date()",value,getLunarDay.default)
      ...
      return h(
        ...
        [h(
          'div',
          { 'class': [_sPrefixCls + '-value',value._d-new Date()<-86400000?'passDate':''],display: 'flex','align-items': 'center'},
          [h('span',{'class':'date'},[zerofixed(value.date())]),h('span',{'class':'lunarDay','style':'margin-left: 5px'},[getLunarDay.default( value._d.getFullYear(),value._d.getMonth()+1,value._d.getDate() ).substr(-2)])]
        ), h(
          'div',
          { 'class': _sPrefixCls + '-content' },
