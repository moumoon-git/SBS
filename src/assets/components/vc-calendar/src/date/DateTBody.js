  ...
  render: function render() {
    ...
    for (iIndex = 0; iIndex < _DateConstants2['default'].DATE_ROW_COUNT; iIndex++) {
      ...
      for (jIndex = 0; jIndex < _DateConstants2['default'].DATE_COL_COUNT; jIndex++) {
        ...
        current._d.setDate(current._d.getDate() -1);
        ...
        // console.log(`(0, _util.getTitleString)`,(0, _util.getTitleString),current,current._d)
          ...
          dateCells.push(h(
            'td',
            {
              ...
              'class': [cls,current._d.getDay()==0?'Sunday':(current._d.getDay()==6?'Saturday':'')]
            },
            [dateHtml]
          ));
