 ...
 * @author xrw
 * @data 2019/11/29
 * @description 通过stomp.js连接ActiveMQ，使用Queue模式
 */
import ucsEvent from './icpInterface19.0.js';
 ...
 * @description 连接MQ方法
 */
async function connect_server(listenMQServer,myCode,deCode,mqUser,mqPwd,logCallBack) {
