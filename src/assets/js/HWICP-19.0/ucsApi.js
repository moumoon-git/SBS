 ...
 *@date 2019/12/10
 */
function InitSDK(ucsServer, listenMQServer, userCode, agentCode, isFirstLogin, logCallBack) {
  ...
  axios.post(ucsServer + '/ucs/communication/init', {'data': {}}).then(async function (data) {
    if (data.data.errorcode === 0) {
      ...
      let sysConfig = {ucsServer, listenMQServer, userCode, agentCode, isFirstLogin, logCallBack};
