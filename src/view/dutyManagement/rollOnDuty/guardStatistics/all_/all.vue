...
<template>
  <div class="div">
    <my-table id="table-content" :tableColumn="tableColumn" :tableData="tableData" @handleCurrentChange="rowclick"></my-table>
    <el-pagination :small="pagingSize" :page-size="pageSize" :total="total" @current-change="test(false)" :current-page.sync="currentPage"
  ...
  export default {
    ...
    methods: {
      ...
      test(time, todolist) {
        ...
        console.log(this.siteType,data)
        if (this.siteType == 1) {
