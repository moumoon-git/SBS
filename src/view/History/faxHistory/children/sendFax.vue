        ...
        <div class="table_box mgb14">
          ...
          >
            ...
            <template slot="failedResend" slot-scope="data">
              <!--              <div style="color: #F46666">{{data.slotData.failed + data.slotData.resend}}</div>-->
              <div style="color: #f46666">{{ data.slotData.failed }}</div>
            </template>
            <!--收信人数-->
            <template slot="receivedCount" slot-scope="data">
              <div>{{ data.slotData.success + data.slotData.failed }}</div>
            </template>
          </myTable>
        </div>
      ...
      <el-col :span="9" style="padding: 0 14px">
        ...
        <div class="fax_queue">
          ...
          <div class="fax_queue_table mgb14">
            ...
            >
              <template slot="unit_fax" slot-scope="data">
                <p v-if="data.slotData.unit" class="reset_p">
                  {{ data.slotData.unit }}
                </p>
                <p v-if="data.slotData.phone" class="reset_p">
                  {{ data.slotData.phone }}
                </p>
              </template>
...
export default {
  ...
  data() {
    return {
      ...
      rowData: null, //点击发送表格存放单行数据,防止多次点击同一行而重复请求
      ...
      tableColumn: [
        ...
        { label: "收信人数", width: 135, prop: "receivedCount", slot: true },
      ...
      // 传真表格数据配置
      tableFaxColumn: [
        { label: "单位", prop: "unit_fax", slot: true },
