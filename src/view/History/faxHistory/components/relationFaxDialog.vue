      ...
      <el-col :span="14" style="border-right: 1px solid #E9EBF0;">
        ...
        <el-col :span="14" style="border-left: 1px solid #E9EBF0;">
          ...
          <div class="my_table" :style="contactName === '最近联系人'?{'min-height': '658px'}:{'min-height': '615px'}">
            <myTable ref="faxTable" :tableColumn="tableColumn" :tableData="tableData" :tableConfig="tableConfig" @rowClick="rowClick" @selectAll="selectFaxAll" @selectionRow="selectionFaxRow"></myTable>
          </div>
      ...
      submitPhones(){
        if(this.phonesText.length==0){
          ...
          numberCorrect.forEach(numE =>{
            let someNumber = this.tags.some(tagE =>{ return numE === tagE.number || numE === tagE.call || numE === tagE.fax})
            if (someNumber){
