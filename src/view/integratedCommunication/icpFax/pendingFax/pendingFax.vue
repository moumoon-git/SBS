...
<script>
  ...
  import FaxTable from "@/view/integratedCommunication/icpFax/pendingFax/faxTable";
  import FaxDetails from "@/view/integratedCommunication/icpFax/pendingFax/faxDetails";
