<template>
  <div>
    <el-dialog title="新增分组" :visible.sync="dialogVisible" width="695px" :close-on-click-modal="false">
      <!-- 通讯录 -->
      <add-contact
        ref="addContact"
        ...
        <div class="contactor-box">
          ...
          >
            <div class="control-wrap">
              <img
                class="del-btn"
                :src="require('@/assets/icpImg/editGroupDel1.png')"
              ...
              <img
                ...
                :src="
                  require(index === 0
                    ? '@/assets/icpImg/editGroupPre1.png'
                    : '@/assets/icpImg/editGroupPre2.png')
                "
              ...
              <img
                ...
                :src="
                  require(index === formData.principals.length - 1
                    ? '@/assets/icpImg/editGroupNext1.png'
                    : '@/assets/icpImg/editGroupNext2.png')
                "
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        "info.name": [{ required: true, message: " ", trigger: "blur" }],
        "info.mobile": [{ validator: REGULAR.phoneReg, trigger: "blur" }],
        "info.officeTel": [
  ...
  created() {
    ...
    if (!this.node.data) {
      ...
      this.formData.parentUnit = this.node.data.name;
