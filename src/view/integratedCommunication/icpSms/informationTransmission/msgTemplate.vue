...
import MsgTemplateDialog from "@/view/integratedCommunication/icpSms/informationTransmission/msgTemplateDialog";
...
export default {
  ...
  methods: {
    ...
    selectTemplate() {
      this.$emit("selectTemplate", { text: this.content, id: this.mainid });
    },
    saveTemplateContent() {
      let data = {
