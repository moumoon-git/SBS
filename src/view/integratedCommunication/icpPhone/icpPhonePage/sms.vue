    ...
    <!-- <template v-if="tabPosition1==1"> -->
        ...
        <div class="my-phone-main" v-show="tabPosition==1||tabPosition==2||tabPosition==3">
          ...
          <div class="my-table-box" v-if="tabPosition==1" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable1" :data="formData1.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
          ...
          <div class="my-table-box" v-if="tabPosition==2" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table
              ...
              @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll"
            >
              <el-table-column type="selection"></el-table-column>
        ...
        <div class="my-phone-main" v-show="tabPosition==4">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable4" :data="formData4.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
        ...
        <div class="my-phone-main" v-show="tabPosition==5">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable5" :data="formData5.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
        ...
        <div class="my-phone-main" v-show="tabPosition==6">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable6" :data="formData6.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
        ...
        <div class="my-phone-main" v-if="tabPosition==7">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable7" :data="formData7.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
        ...
        <div class="my-phone-main" v-else-if="tabPosition==8">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable8" :data="formData8.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="min-height: 600px;width:100%;overflow: auto;" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
              <el-table-column show-overflow-tooltip align="center"
                               v-for="(item,key) in tableColumn" :key="key" :label="item.label" :prop="item.prop"
            ...
            <el-row>
              ...
              :current-page="formData8.currentPage" layout="total, prev, pager, next, jumper"
                             @current-change="handCurrentChange"
        ...
        <div class="my-phone-main" v-show="tabPosition==9">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable9" :data="formData9.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
        ...
        <div class="my-phone-main" v-if="tabPosition==10">
          ...
          <div class="my-table-box" style="box-sizing: border-box;overflow: auto;">
            ...
            <el-table ref="elTable10" :data="formData10.tableData" highlight-current-row
                      :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                      style="width:100%;height:600px;overflow: auto;" @row-dblclick="handleRowDbClick" @row-click="handleRowClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
              <el-table-column type="selection"></el-table-column>
              <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
