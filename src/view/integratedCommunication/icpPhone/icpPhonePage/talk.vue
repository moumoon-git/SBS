  ...
  <div class="my-radio-box">
          ...
          <el-row  class="my-table-box-search" style="margin:10px;">
            ...
            <el-col :span="10">
              <el-button type="primary"  @click="handleSearch" style="margin-left:10px;">搜索</el-button>
                ...
                <el-table ref="elTable1" :data="myData1.tableData" highlight-current-row
                  :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                  style="width:100%;min-height:600px;overflow: auto;"  @row-click="handleRowClick" @row-dblclick="handleRowDbClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
      ...
      <div  class="my-phone-main" v-if="tabPosition==2">
        ...
        <div class="my-table-box">
            ...
            <el-row  class="my-table-box-search" style="margin:10px 0 10px 8px;">
              ...
              <el-table ref="singleTable" :data="myData2.tableData" highlight-current-row
                height="586px"
                :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                style="width:100%;" @row-click="handleRowClick" @row-dblclick="handleRowDbClick">
                  <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column>
                    <el-table-column   show-overflow-tooltip align="center"
      ...
      <div  class="my-phone-main" v-if="tabPosition==3">
        <div class="my-tree-box">
          ...
          <el-scrollbar class="my-tree-scroll">
            <el-tree :data="myData3.treeData" :default-expanded-keys="[expandId]"   @node-click="handleNodeClick"  node-key="id" ref="tree" highlight-current :props="defaultProps"></el-tree>
          </el-scrollbar>
        </div>
        <div class="my-table-box">
          <btn-box :btnArry="btnArry2" v-bind="{
          ...
          <el-table ref="singleTable" :data="myData3.tableData" highlight-current-row
                    height="586px"
          ...
          <el-row  class="my-table-box-search" style="margin:10px;">
            ...
            <el-col :span="10">
              <el-button type="primary"  @click="handleSearch" style="margin-left:10px;">搜索</el-button>
                ...
                <el-table ref="elTable4" :data="myData4.tableData" highlight-current-row
                  :header-cell-style="{background:'#E6E6E6',color:'#606266'}"
                  style="width:100%;min-height:600px;overflow: auto;"  @row-click="handleRowClick" @row-dblclick="handleRowDbClick" @selection-change="handleSelectionChange" @select="handleSelect" @select-all="selectAll">
                    <el-table-column type="selection"></el-table-column>
                    <!-- <el-table-column type="index" width="50" :resizable="false" align="center"></el-table-column> -->
