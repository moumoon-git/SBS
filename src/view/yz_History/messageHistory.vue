...
<script>
    ...
    import faxHistory from '@/view/yz_History/faxHistory/faxHistory'
    import msgHistory from '@/view/yz_History/msgHistory/msgHistory'
    import phoneHistory from '@/view/yz_History/phoneHistory/phoneHistory'
    import conferenceHistory from '@/view/yz_History/conferenceHistory/conferenceHistory'
      export default {
        name: "messageHistory",
        components:{
        ...
        methods:{
          changTab(tabName) {
            ...
            this.$router.push({path:'/messageHistory'})
          },
        }
    }
</script>
