  ...
  export default {
    ...
    methods: {
      ...
      test(row) {
        ...
        //console.log(row)
        //console.log(row.eventId,row.eventDeal)
      ...
      //保存
      ok() {
        console.log(this.todolist, this.eventboxId)
        let evenid = this.eventboxId == '' ? this.todolist : this.eventboxId;
        console.log(this.id, evenid, this.formLabelAlign.name);
        let data = {
          eventId: evenid,
          id: this.id,
