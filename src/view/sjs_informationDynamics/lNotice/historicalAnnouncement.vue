...
import TableDetails from "@/view/sjs_informationDynamics/lNotice/tableDetails";
import workPopup from "@/view/sjs_informationDynamics/workPopup";
  ...
  methods: {
    ...
    handleAdd() {
      this.$nextTick(() => {
        ...
        this.$refs.WorkPopup.title = "新增公告";
        this.$refs.WorkPopup.workForm.type = 372;
    ...
    handleEdit() {
      ...
      this.$refs.WorkPopup.isDialogVisible = true;
      this.$refs.WorkPopup.title = "修改公告";
