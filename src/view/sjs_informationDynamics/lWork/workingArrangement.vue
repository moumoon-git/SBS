...
<script>
  ...
  import TableDetails from "@/view/sjs_informationDynamics/tableDetails";
    ...
    methods: {
      ...
      handleAdd() {
        this.$nextTick(() => {
          ...
          this.$refs.WorkPopup.title = "新增工作安排";
          this.$refs.WorkPopup.workForm.type = 373;
      ...
      handleEdit() {
        ...
        this.$refs.WorkPopup.isDialogVisible = true;
        this.$refs.WorkPopup.title = "修改工作安排";
