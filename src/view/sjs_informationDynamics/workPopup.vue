                  ...
                  <el-form-item label="附件:" style="text-align: left">
                    ...
                    >
                      ...
                      <div slot="tip" class="el-upload__tip">
                        限doc,docx,xls,xlsx,png,jpg,gif,jpeg,pdf,txt,zip,rar，且不超过50mb
                      </div>
                    </el-upload>
                  </el-form-item>
                </el-row>
      ...
      this.$refs[formName].validate((valid) => {
        ...
        if (this.title.indexOf("新增") !== -1) {
          let data = {
            data: this.workForm,
            att: this.att,
            // operatorId: sessionStorage.getItem('operator_id') // 后端要求传参，暂时用不到
          };
