...
<script>
  ...
  import communicationScheduling from "@/view/eventManagement/emergencyResponse/Page/communicationScheduling"
  import dutyDispatch from "@/view/eventManagement/emergencyResponse/Page/dutyDispatch"
  import responseSituation from "@/view/eventManagement/emergencyResponse/Page/responseSituation"
  import emergencyDepartments from "@/view/eventManagement/emergencyResponse/Page/emergencyDepartments"
  import addProcessContentPopup from "@/view/eventManagement/emergencyResponse/Plan/addProcessContentPopup";
  export default {
