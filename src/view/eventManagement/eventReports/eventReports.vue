      ...
      <div style="background-color: white; margin: 0 15px 0 20px">
        ...
        >
          <el-scrollbar style="height: 100%; background-color: white">
            ...
            ></condition-collect>
            <!-- authorName qinjiaqi -->
            <!--南山显示该按钮，非南山项目v-show为false不显示
            <div v-show="IsNanShan" style="width: 200px;margin:10px auto;">
                <el-button 
                    :class="{'end-style':isEnd, 'not-end-style':!isEnd}" @click="endEvent"
...
import eventBack from "@/view/eventManagement/eventReports/Page/eventBack";
import criminalHistory from "@/view/eventManagement/eventReports/Page/criminalHistory";
import eventContact from "@/view/eventManagement/eventReports/Page/eventContact";
import extendInformation from "@/view/eventManagement/eventReports/Page/extendInformation";
import operatingRecord from "@/view/eventManagement/eventReports/Page/operatingRecord";
import overallSituation from "@/view/eventManagement/eventReports/Page/overallSituation";
import smallMobilePlatform from "@/view/eventManagement/eventReports/Page/smallMobilePlatform";
import testSpecification from "@/view/eventManagement/eventReports/Page/testSpecification";

import informationToVerify from "@/view/eventManagement/eventReports/Page/affectionHandle/informationToVerify";
import truthInitial from "@/view/eventManagement/eventReports/Page/affectionHandle/truthInitial";
import messageSubmission from "@/view/eventManagement/eventReports/Page/affectionHandle/messageSubmission";
import submissionReview from "@/view/eventManagement/eventReports/Page/affectionHandle/SubmissionReview";
import leadConductor from "@/view/eventManagement/eventReports/Page/affectionHandle/leadConductor";
import instructConvey from "@/view/eventManagement/eventReports/Page/affectionHandle/instructConvey";
import conditionTop from "@/view/eventManagement/eventReports/Page/affectionHandle/conditionTop";
import startPlan from "@/view/eventManagement/eventReports/Page/affectionHandle/startPlan";
  ...
  methods: {
    ...
    actives(index, title) {
      ...
      this.$nextTick(() => {
        ...
        this.$refs.messageSubmission.tabsTitle = title; // 发送时判断是信息报送标识 如果换成石景山的信息报送（有独立的发送接口应注释）author:xuchuangxing lastUpdateTime:2021/1/29
      });
    },
    setClick(index, name, buttons, caseName, caseId) {
      ...
      if (this.navBarList[lengith].name == "事件联系人") {
        ...
        this.navBarList.push({ name: name[0].name });
        this.selectedName = "事件联系人";
        this.$refs.navBar.activeName = "事件联系人";
