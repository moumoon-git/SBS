<template>
  <div style="padding: 0 10px">
    <div style="width: 100%;height: 200px;overflow: auto">
      <!--表格-->
      <div>
        <lead-conductor-table
          ref="batchTable"
          @handleSelectionChange="handleSelectionChange"
          @handleCurrentChange="handleCurrentChange"
          @delete="rowDeleteLead"
          @select="rowSelect"
          :tableColumn="tableColumn"
          :tableData="tableData"></lead-conductor-table>
      </div>
      <!--表格分页-->
    ...
    <div class="formStyle">
      ...
      <el-form label-width="75px" :model="ruleForm" :rules="rules" ref="ruleForm" @submit.native.prevent
          ...
          <el-col :span="10">
            <el-form-item label="指示时间:" prop="instructionsTime" label-width="92px">
              <el-date-picker
                ...
                :disabled="disabled"
                v-model.trim="ruleForm.instructionsTime"
                type="datetime"
                placeholder="选择日期时间">
              </el-date-picker>
            </el-form-item>
      ...
      <div style="display: flex ;margin-top: 20px;border-bottom: 1px solid #ccc;padding-bottom: 10px">
          ...
          <el-form  label-width="18%" :model="form" :rules="formRules" ref="form" @submit.native.prevent  label-position="right">
            ...
            <el-row style="text-align: left">
              <el-form-item label="传达对象:" >
                <el-input
                  :readonly="objDisabled"
                  type="textarea"
                  v-model="form.conveyObj"
                  show-word-limit
                  resize="none"
...
<script>
    import leadConductorTable from "@/view/eventManagement/eventReports/dialog/batchTable"
...
<style scoped>
  ...
  .formStyle >>>.el-date-editor.el-input, .el-date-editor.el-input__inner{
    width: 100%;
  }
</style>
