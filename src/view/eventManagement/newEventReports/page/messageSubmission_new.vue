<template>
  <div class="messageSubmission_wrap">
    <el-row style="display: flex; height: 100%">
      <el-col>
        <div
          ...
          class="flex_wrap"
        >
          <div class="commonInfo" style="height: 100%">
            <div class="phoneHeader">
              <el-radio-group class="phoneHeaderRadio" v-model="activeAllModel">
                ...
                <el-radio-button label="传真"></el-radio-button>
              </el-radio-group>
              ...
              <div class="phoneIndex_header" v-if="activeAllModel == '电话'">
                <div class="phoneIndex_header_Tab" @click="tabShortcutGroup">
                  ...
                  <img
                    v-else
                    src="/static/img/Communihistory/shortcutGroupHover.png"
                    alt=""
                  />
                  <span>快捷组</span>
                </div>
                          ...
                          >
                            ...
                            <el-dropdown-menu slot="dropdown">
                              <el-dropdown-item>
                                ...
                                <div
                                  class="selectPhoneCell"
                                  v-if="item.phoneAllObj.otherTel"
                                >
                                  <span
                                    >备用号码：{{
                                      item.phoneAllObj.otherTel
                                    }}</span
                                  >
                                  <img
                                    @click="
                                      callPhone(item.phoneAllObj.otherTel)
                                    "
                                    src="/static/img/Communihistory/cell1.png"
                                    alt=""
                                  />
                                ...
                                >
                                  ...
                                  <img
                                    @click="
                                      callPhone(item.phoneAllObj.officeTel)
                                    "
                                    src="/static/img/Communihistory/cell1.png"
                                    alt=""
                                  />
                                ...
                                <div
                                  class="selectPhoneCell"
                                  v-if="item.phoneAllObj.otherTel2"
                                >
                                  <span
                                    >其他电话：{{
                                      item.phoneAllObj.otherTel2
                                    }}</span
                                  >
                                  <img
                                    @click="
                                      callPhone(item.phoneAllObj.otherTel2)
                                    "
                                    src="/static/img/Communihistory/cell1.png"
                                    alt=""
                                  />
...
import phoneHistoryIndex from "@/view/eventManagement/informationDisposal/communicationHistory/phoneHistoryIndex";
import msgHistonryIndex from "@/view/eventManagement/informationDisposal/communicationHistory/msgHistonryIndex";
...
import InformaHistory from "@/view/eventManagement/informationDisposal/communicationHistory/comonnTemplat/InformaHistory"; // 传真历史
...
export default {
  ...
  mounted() {
    ...
    let wrap = document.getElementsByClassName("messageSubmission_wrap")[0];
    if (wrap.parentNode) {
    ...
    getHeight() {
      ...
      console.log(
        "this.heightStyle.height" +
          this.heightStyle.height +
          "this.rightHeightStyle.height" +
          this.rightHeightStyle.height
      );
      console.log(
        "this.saveEntering.height" +
          this.saveEntering.height +
          "this.turnTheText.height" +
          this.turnTheText.height
      );
    },
    getTabDatas() {
...
.messageSubmission_wrap >>> .tabsClass {
  background: #ffffff;
}

.messageSubmission_wrap >>> .el-tabs__header.is-top {
  margin: 0;
  height: 52px;
  border-bottom: 0;
}

.messageSubmission_wrap >>> .el-tabs__nav-wrap.is-top {
  color: #a2a2a2 !important;
  /* background: #f9fbff; */
  height: 52px;
}

.messageSubmission_wrap >>> .el-tabs__nav-scroll {
  margin-top: 10px;
}

.messageSubmission_wrap >>> .el-tabs__item {
  font-size: 17px;
  color: #a2a2a2;
}

.messageSubmission_wrap >>> .el-tabs__item.is-active {
  color: #409eff;
  padding-left: 10px;
}

.messageSubmission_wrap >>> .el-tabs__item:hover {
  color: #6b7280;
}

.messageSubmission_wrap
  >>> .el-tabs
  .el-tabs__header
  .el-tabs__nav-scroll
  .el-tabs__nav.is-top {
...
.messageSubmission_wrap >>> .my-phone-right-main .sendMsg .operation {
  margin: 20px 0px !important;
}
.messageSubmission_wrap .phoneHeaderRadio >>> .el-radio-button__inner {
  padding: 10px 20px;
}
>>> .MessageHandling > div {
  /* height: 100%;
...
.messageSubmission_wrap >>> .my-phone-right-main-user {
  padding: 0 !important;
...
.messageSubmission_wrap >>> .sendMsg {
  overflow: hidden;
  padding-bottom: 0;
}
.messageSubmission_wrap >>> .sendMsg .el-tabs {
  /* margin: 0 20px; */
}
...
.messageSubmission_wrap >>> .my-sms-box {
  height: 214px !important;
  padding-top: 0 !important;
}
.messageSubmission_wrap >>> .my-sms-box .NoSMSList {
  height: 214px;
  font-size: 14px;
  font-weight: 500;
  line-height: 345px;
}
.messageSubmission_wrap >>> .my-fax-head {
...
.messageSubmission_wrap .phoneHeaderRadio {
  display: flex;
  margin: 10px 0;
}
...
.messageSubmission_wrap .commonInfo {
  display: flex;
  flex-direction: column;
}
...
.messageSubmission_wrap .framework_right_footer {
  position: relative;
  margin-bottom: 3px;
}

.messageSubmission_wrap .framework_right_footer > span {
  position: absolute;
  z-index: 100;
  top: 4px;
  bottom: 0;
...
.messageSubmission_wrap .framework_right_footer >>> .el-pagination {
  position: relative;
  text-align: center;
}

.messageSubmission_wrap .framework_right_footer >>> .el-pagination__jump {
  font-size: 0;
  position: absolute;
  left: 34%;
  height: 25px;
...
.messageSubmission_wrap .framework_right_footer >>> .el-pagination .btn-next,
.messageSubmission_wrap .framework_right_footer >>> .el-pagination .btn-prev {
  position: relative;
  z-index: 99;
}
...
/* .messageSubmission_wrap .MessageHandling >>> .relatedEvents{
    display: none;
    margin: 10px 10px;
  } */
.messageSubmission_wrap .tabpanel >>> .el-scrollbar__wrap {
  overflow: hidden;
}
</style>
