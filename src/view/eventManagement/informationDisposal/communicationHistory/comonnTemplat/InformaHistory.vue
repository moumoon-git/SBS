<template>
  <div class="InformaHistory_wrap">
        ...
        <ul class="InformaHistory_content_ul" v-if="listData.length>0">
          <li class="InformaHistory_content_li" v-for="(item,index) in listData" :key="index">
            <div class="InformaHistory_content_li_left">
              <img
                src="../../../../../../static/img/Communihistory/msg.png"
                alt
                v-if="item.type=='sms'"
              />
              <img
                src="../../../../../../static/img/Communihistory/phone.png"
                alt
                v-if="item.type=='phone'"
              />
              <img
                src="../../../../../../static/img/Communihistory/fax.png"
                alt
                v-if="item.type=='fax'"
              />
            </div>
            <div class="InformaHistory_content_li_right">
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type=='sms'">
                ...
                <div>
                  <span
                    v-for="(el, _index) in item.list"
                    :key="_index"
                  >{{el.contactor ? el.contactor : el.phone + (_index + 1 === item.list.length ? '' : '、')}}</span>
                </div>
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type=='fax'">
                ...
                >
                  ...
                  <span class="cellPhoneImg" @click="callPhoneAssign(v)" v-if="v.phone"></span>
                </div>
              </div>
    ...
    <!-- 移除记录 -->
    <el-dialog title="移除通讯记录" :visible.sync="removeRecordVisiable" width="350px" append-to-body :close-on-click-modal="false">
