  ...
  export default {
    ...
    methods: {
      ...
      callPhoneAssign(item) {
        ...
        // }
        console.log(item.mobile || item.mobile1 || item.homeTel || item.officeTel)
...
<style scoped>
  ...
  .framework_right_footer >>> .el-pagination .btn-next .el-icon, .framework_right_footer >>> .el-pagination .btn-prev .el-icon {
    font-size: 18px;
  }
  ...
  .framework_right_footer >>> .el-pagination__jump .el-pagination__editor.el-input,
  .framework_right_footer >>> .el-pagination__jump .el-pagination__editor.el-input .el-input__inner {
    width: 57px;
    height: 25px;
  }
