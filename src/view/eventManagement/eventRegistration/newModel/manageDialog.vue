                    ...
                    <el-tabs type="border-card" style="height: 716px">
                      <el-tab-pane label="原件预览">
                        <div style="width: 100%;height: 647px;">
                          <iframe :src="fpxPreviewPath" id="fpxIframe" width="100%" height="100%" v-if="fpxPreviewPath!=''"
...
<script>
    ...
    import audioCompName from '@/view/eventManagement/eventRegistration/newModel/audio'
