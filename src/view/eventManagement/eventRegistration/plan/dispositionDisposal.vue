...
<script>
    import phoneModel from '@/view/eventManagement/eventRegistration/plan/phoneModel'
    import smsModel from '@/view/eventManagement/eventRegistration/plan/smsModel'
    import faxModel from '@/view/eventManagement/eventRegistration/plan/faxModel'
    export default {
