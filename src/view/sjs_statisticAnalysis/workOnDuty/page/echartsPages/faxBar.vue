<!--
  ...
  @description: 统计分析-值班统计分析-传真统计-柱状图（优化版）。
-->
<template>
...
<script>
    ...
    export default {
        ...
        methods: {
           ...
           * @param {number/string/Function} barNum  y轴坐标轴刻度最大值。
           * @lastAuthor hexinting
           * @lastDate 2020-9-21
           * @decription 绘制echarts图标
           */
          drawLine(barXdata,barSeries,legendData,barNum) {
            console.log(barNum);
