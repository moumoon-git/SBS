<!--
  ...
  @description: 统计分析-值班统计分析-话务统计-柱状图（优化版）
-->
<template>
...
<script>
    ...
    export default {
        ...
        methods: {
           ...
           */
          drawLine(barXdata,barSeries,legendData,maxNum) {
            console.log(barXdata,barSeries,'来来来');
            ...
            let option = {
              ...
              xAxis: {
                ...
                data: barXdata, // 类目数据，在类目轴（type: 'category'）中有效。
