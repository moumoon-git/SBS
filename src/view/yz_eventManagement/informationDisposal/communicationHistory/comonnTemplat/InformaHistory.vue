        ...
        <ul class="InformaHistory_content_ul" v-if="listData.length > 0">
          <li class="InformaHistory_content_li" v-for="(item, index) in listData" :key="index">
            <div class="InformaHistory_content_li_left">
              <img src="/static/img/Communihistory/msg.png" alt v-if="item.type == 'sms'" />
              <img src="/static/img/Communihistory/phone.png" alt v-if="item.type == 'phone'" />
              <img src="/static/img/Communihistory/fax.png" alt v-if="item.type == 'fax'" />
              <img src="/static/img/Communihistory/approval.png" alt v-if="item.type == 'approval'" />
              <img src="/static/img/Communihistory/emil.png" alt v-if="item.type == 'emil'" />
            </div>
            <div class="InformaHistory_content_li_right">
              <div
                ...
                "
              >
                {{ isYangZhou?item.time.substring(0,item.time.lastIndexOf(':')):item.time }}
                <i
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type == 'sms'">
                <span>收信人:</span>
                <div>
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type == 'fax'">
                <span>收信人:</span>
                <div
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type == 'phone'">
                <span>联系人:</span>
                <div>
                  {{ item.contactor }}
                  <span
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type == 'fax'">
                <span>传真件:</span>
                <el-link @click="filePreview(item.url)">{{ item.url }}</el-link>
                <img
                  @click="fileDownLoad(item.url)"
              ...
              <div class="InformaHistory_content_li_right_div" v-if="item.type == 'phone'">
                ...
                <div id="content_del" v-if="item.url">
                  ...
                  <audio style="display: none" controls :src="apiUrl + '/rec/' + item.url"></audio>
                </div>
              </div>
        ...
        audio() {
            setTimeout(() => {
                ...
                let play = require('@/../static/audioControls/play.png'),
                    stop = require('@/../static/audioControls/stop.png'),
                    dow = require('@/../static/audioControls/dow.png'),
                    // bug8637 图片裂掉，测试说可以保留图片展示  qinjiaqi 20201130
