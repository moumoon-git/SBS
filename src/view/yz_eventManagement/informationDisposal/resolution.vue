<template>
<div class="resolution_wrap" v-show="flag">
    <div class="resolution_content">

        <div class="header">
            <span>拆分传真</span>
            <img @click="flag=false" src="../../../../static/img/Communihistory/close.png" alt="">
        </div>
        ...
        <div class="content">
            ...
            <div class="resolution_content_left">
                <div class="resolution_content_left_top">
                    <div class="resolution_content_left_top_top">
                        ...
                        <iframe :src="rawFaxPath" width="100%" height="100%" v-if="rawFaxPath!=''" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
                        <div v-else style="
            ...
            <div class="resolution_content_right">
                <iframe :src="mianContentFaxPath" id="fpxIframe" width="100%" height="100%" v-if="mianContentFaxPath!=''" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
                <div v-else style="
              width: 100%;height: 100%;
              background: url('/static/img/faxBack.png') center no-repeat;
              background-size: 220px;">
...
export default {
    ...
    methods: {
         ...
         * @updateTime  :20201029 16:50
         * @param {*} arr :要合并拆分的后的所选的数据
         * @return {*}
         */
        faxmergePdf(arr) {
            if (arr.length != 0) {
