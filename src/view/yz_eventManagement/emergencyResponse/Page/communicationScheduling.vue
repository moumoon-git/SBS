...
<script>
  import noteCheck from "@/view/yz_eventManagement/emergencyResponse/Plan/noteCheck"
  import phoneCheck from "@/view/yz_eventManagement/emergencyResponse/Plan/phoneCheck"
