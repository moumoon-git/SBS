                              ...
                              this.$api.iStarted(isData).then((res) => {
                               if(!res.data){
                                 ...
                                 if(this.MapProjectUrl===true){ 
                                   window.open(UrlMap+'/login.html?usernames='+this.usernames+'&psw='+this.psw+'&machineID='+this.ip+'&agent_id='+agent_id+'&iddcode='+iddcode+''+`&Authorization=${localStorage.getItem("token")? localStorage.getItem("token"): ""}`)
                                 }else {
                                   window.open(UrlMap+'/dispatch.html?machineID='+this.ip+'&agent_id='+agent_id+'&iddcode='+iddcode+''+`&Authorization=${localStorage.getItem("token")? localStorage.getItem("token"): ""}`)
                                 }
                                 this.$message({
                                   message: '调整预案成功',
                                   type: 'success'
