<template>
  <div style="height:428px;">
    <el-tabs v-model="activePhone">
      <el-tab-pane name="keyboard" label="键盘拨号">
        <div>
          <div class="telBox">
      ...
      <el-tab-pane name="queue" label="通话队列">
                ...
                <template v-for="(items, index) in callQueue">
                  <div class="showPhone" @click='clickPhone(items,index)'
                    ...
                    <div class="showPhoneRight">
                      <div @click='release(items,index)'><i class="el-icon-video-pause"></i></div>
                    </div>
                  </div>
                </template>
              </el-scrollbar>
