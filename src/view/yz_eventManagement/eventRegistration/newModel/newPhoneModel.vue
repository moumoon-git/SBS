...
<script>
  import phoneAddressBookTree from '@/view/yz_eventManagement/eventRegistration/newModel/smsPhoneTree'
  import phoneQuickGroup from '@/view/yz_eventManagement/eventRegistration/newModel/quickGroup'
  import phoneCallLogModel from '@/view/yz_eventManagement/eventRegistration/newModel/callLogModel'
  import figurePlate from '@/view/yz_eventManagement/eventRegistration/newModel/figurePlate'
