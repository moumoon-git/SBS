...
<script>
import myTable from "@/view/yz_History/components/myTable";
import smsAddressBookTree from "@/view/yz_eventManagement/eventRegistration/newModel/smsPhoneTree";
import smsQuickGroup from "@/view/yz_eventManagement/eventRegistration/newModel/quickGroup";
import smsCallLogModel from "@/view/yz_eventManagement/eventRegistration/newModel/callLogModel";
...
export default {
  ...
  methods: {
    ...
    sendSmsContent() {
      ...
      console.log(data);
      // 扬州项目需求：发送之前添加提醒 任务133 author:hexinting date:2020-10-15
      this.smsData = data;
    ...
    sendSms(data) {
      ...
      if (this.IsYangZhouProject) {
        this.promptConfig.visible = false; // 隐藏提示弹窗
      }
    },
    /**
     * @lastAuthor hexinting
