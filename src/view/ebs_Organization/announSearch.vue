                ...
                <el-tabs v-model="activePart" type="card">
                    <el-tab-pane label="通讯联络网" name="first">
                        <el-scrollbar style="height: 500px;">
                            <el-tree v-if="visible" :data="treeData" :props="props" @node-click="nodeClick" ref="tree" node-key="id"
                            :render-content="renderContent" highlight-current  :default-expanded-keys="[indexKey]"></el-tree>
                        </el-scrollbar>
                    </el-tab-pane>
                </el-tabs>
...
import Form from '../LiaisonNet/LiaisonNetForm'
import LiaisonNetSide from '../LiaisonNet/LiaisonNetSide'
export default {
