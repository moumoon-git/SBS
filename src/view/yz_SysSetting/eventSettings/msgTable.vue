<template>
  <el-scrollbar class="widthClass">
    ...
    >
      ...
      ></el-table-column>
      <el-table-column label="操作"  :resizable="false" min-width="60" fixed="right" >
        <template slot-scope="scope">
          <el-row>
            <el-col :span="12" >
              <el-link v-show="updateButton" type="warning" size="mini" @click="handleUpdate(scope.row)">修改</el-link>
            </el-col>
            <el-col :span="12" >
              <el-link v-show="deleteButton" type="danger" size="mini" @click="handleDelete(scope.row.id)">删除</el-link>
            </el-col>
          </el-row>
        </template>
      </el-table-column>
