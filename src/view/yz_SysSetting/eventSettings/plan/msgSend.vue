<template>
  <div style="width:100%" >
      <el-col :span="5" style="border-right: 1px solid #ddd">
        <div style="width: 100%;height:395px;overflow-y: auto;">
...
<script>
    import msgTable from '@/view/yz_SysSetting/eventSettings/msgTable'
    import msgSelectDialog from "@/view/yz_eventManagement/eventReports/dialog/selectDialog"
    export default {
        name: "msgSend",
        props:['treeId'],
         components:{
