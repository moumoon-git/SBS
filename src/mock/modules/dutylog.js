...
const dutylogs = {
  ...
  dutylogs_listByDate: {url: '/duty/dutyLogItem/listWithUnfinished', method: 'GET'},  // 根据日期查询交班事项
  // dutylogs_uploadImg: {url: '/upload/dutyLogOperationsImages', method: 'POST'},  // 上传图片
  dutylogs_uploadImg: {url: '/appAttachment/fileUploadAttachment', method: 'POST'},  // 上传图片
